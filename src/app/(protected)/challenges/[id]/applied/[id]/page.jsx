...
export default function ChallengeDeletedPage() {
  ...
  if (isLoading) {
    return (
      <div className="py-20 text-center text-16-regular text-gray-500 font-pretendard">
        불러오는 중입니다...
      </div>
    );
  }
  ...
  if (isError || !challenge) {
    return (
      <div className="py-20 text-center text-16-regular text-red-error font-pretendard">
        챌린지 정보를 불러오지 못했습니다.
      </div>
    );
  }
