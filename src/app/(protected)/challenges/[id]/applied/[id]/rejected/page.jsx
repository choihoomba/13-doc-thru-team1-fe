...
export default function ChallengeRejectedPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 font-pretendard">
      ...
      <div className="mx-auto mb-6 flex h-[35px] w-[890px] items-center justify-center rounded-full bg-[#FFF0F0] shadow-sm">
        <span className="flex h-[19px] items-center justify-center text-center text-16-semibold text-[#E54946]">
          신청이 거절되었습니다.
        </span>
      </div>
      ...
      <div className="mb-10 w-full rounded-xl border border-gray-200 bg-gray-50 p-8">
        ...
        <div className="mt-6 flex items-center justify-end gap-2 text-14-regular text-gray-400">
          <span>독스루 운영진</span>
          <span>|</span>
          <span>
